...
const AddProduct = ({ setAddFormOpen, addFormOpen, setProducts }) => {
  ...
  const [filteredCategories, setFilteredCategories] = useState([]); // Added to store filtered categories
  ...
  useEffect(() => {
    if (brandId) {
      const filtered = categories.filter((category) => {
        ...
        return category.brand._id === brandId;
      });
  ...
  return (
    <div
      className={`absolute w-full h-full bg-[#004062] p-6 overflow-y-auto rounded-lg shadow-lg z-50 transition-all duration-300 ease-in-out ${
      ...
      <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
        ...
        <div className="flex gap-3">
          ...
          <select
            ...
            disabled={!brandId} // Disable category select if no brand is selected
          >
