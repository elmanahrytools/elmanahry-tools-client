      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center gap-7">
          {cats.map((cat) => (
            <div
              key={cat.id}
              className="relative flex flex-col items-center rounded-2xl shadow-xl bg-mainColor   transition-transform duration-300 overflow-hidden min-w-[170px] max-w-[170px] pb-4"
            >
              {/* Image */}
